...
while True:
	...
	pub = rospy.Publisher('/aruco_pose',Pose, queue_size=10)
	rate  = rospy.Rate(100)
	...
	if ids is not None:
		if ids.any() !=0:
			...
			R_vec, T_vec, _objPoints = aruco.estimatePoseSingleMarkers(corners, 0.06, cameraMatrix, distCoeffs)
			aruco.drawAxis(detected_markers, cameraMatrix,distCoeffs, R_vec, T_vec, 0.1)
